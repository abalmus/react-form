...
exports.Select = function (props) {
    var name = props.name, label = props.label, placeholder = props.placeholder, handleOnClick = props.handleOnClick, handleOnChange = props.handleOnChange, handleOnBlur = props.handleOnBlur, options = props.options, value = props.value, disabled = props.disabled;
    var classList = [

    ...
    Form.prototype.onSubmitHandler = function (event) {
        ...
        this.proofValidation('submit', function () {
            _this.validateForm(function (errors) {
                ...
                var submitPromise = submitHandler({
                    formData: _this.formState,
                    submitSuccess: _this.submitSuccess,
                    submitError: _this.submitError
                });
                if (submitPromise.then && typeof submitPromise.then === 'function') {
                    submitPromise.then(_this.submitSuccess, _this.submitError)

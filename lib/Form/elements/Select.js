...
exports.Select = function (props) {
    var name = props.name, label = props.label, placeholder = props.placeholder, handleOnClick = props.handleOnClick, handleOnChange = props.handleOnChange, handleOnBlur = props.handleOnBlur, options = props.options, value = props.value, disabled = props.disabled, type = props.type;
    var classList = [
    ...
    return React.createElement("div", { className: type + "-field " + classList.join(' ') },
        React.createElement("label", null,
            " ",
            label,
            React.createElement("select", { id: name, name: name, onClick: handleOnClick, onChange: handleOnChange, onBlur: handleOnBlur, value: value, disabled: disabled },
                defaultOption,
